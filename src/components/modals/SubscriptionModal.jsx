    ...
    <div className="subscription-modal-overlay">
      <div className="subscription-modal">
        <div className="subscription-modal__header">
          ...
          <div className="subscription-modal__title-section">
            <h2 className="subscription-modal__app-title">Habit Tracker</h2>
            <p className="subscription-modal__app-subtitle">mini-app</p>
          </div>
          <button className="subscription-modal__menu">
